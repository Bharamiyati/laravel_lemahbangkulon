            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        @endif
                        <form action="{{route('sumberair.update', $data->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        @method('PATCH')    
                        @csrf
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kategori Sumber Air</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" value="{{$data->sumber_air}}" name="txt_sumberair" placeholder="Masukkan kategori sumber air" class="form-control"><small class="form-text text-muted"></small></div>
                            </div>
