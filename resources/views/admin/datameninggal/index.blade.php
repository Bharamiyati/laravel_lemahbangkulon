                        ...
                        <table id="bootstrap-data-table-export" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                ;?>
                                    ...
                                    <td>
                                        <a href="{{route('datameninggal.edit', $row->id)}}" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    </td>
                                    <td>
                                        <form action="{{route('datameninggal.destroy', $row->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
