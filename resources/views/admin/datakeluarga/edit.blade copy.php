                   ...
                   @endif
                    ...
                    <div class="card-body card-block">
                        ...
                        @csrf
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label class=" form-control-label">Air Bersih</label></div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label class=" form-control-label">Jamban keluarga</label></div>
                                <div class="col-12 col-md-5">
                                    <select name="option_jamban" id="select" class="form-control" required>
                                        <option value=""></option>
                                        @foreach($jamban as $jamban)
                                        <?php $j = "Ada";
                                        if ($jamban == "0") {
                                            $j = "Tidak";
                                        }; ?>
                                        <option value={{$jamban}}><?= $j; ?></option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">wajib diisi</div>
                                    <div class="valid-feedback">valid</div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Aset Keluarga</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_aset" placeholder="Masukkan aset" class="form-control"><small class="form-text text-muted"></small></div>
                            </div>
