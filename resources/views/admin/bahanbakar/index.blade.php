            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @can('data-create')
                        <a href="{{route('bahanbakar.create')}}" class="btn btn-success pull-right"> Tambah Data </a>
                        @endcan
                    </div>
                    <div class="card-body">
                        <table id="bootstrap-data-table-export" class="table table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->jenis}}</td>
                                    @can('data-edit')
                                    <td><a href="{{route('bahanbakar.edit', $row->id)}}" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                    @endcan
                                    @can('data-delete')
                                    <td>
                                        <form action="{{route ('bahanbakar.destroy',$row->id)}}" method="post" style="z-index: -1;">
                                            @csrf
                                            @method('DELETE')
