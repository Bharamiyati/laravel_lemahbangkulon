            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <strong>Masukkan Data Kategori Bahan Bakar</strong>
                    </div>
                    <div class="card-body card-block">
                        ...
                        @endif
                        <form action="{{route('bahanbakar.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">kategori Bahan Bakar</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_bahan" placeholder="Masukkan Kategori bahan bakar" class="form-control"><small class="form-text text-muted"></small></div>
                            </div>
