            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('users.create')}}" class="btn btn-success pull-right"> Tambah User </a>
                    </div>
                    <div class="card-body">
                        <table id="bootstrap-data-table-export" class="table table-success table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('users.edit', $row->id)}}" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                    <td>
