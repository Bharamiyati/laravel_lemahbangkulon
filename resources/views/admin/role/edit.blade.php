                    ...
                    <div class="card-body card-block">
                        ...
                        @csrf
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" value="{{ $role->name }}" name="txt_role" placeholder="Masukkan Role" class="form-control"><small class="form-text text-muted"></small></div>
                            </div>
                            <div class="row form-group">
